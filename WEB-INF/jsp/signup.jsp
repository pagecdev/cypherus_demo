		...
		<div class="style-2">
			...
			<div class="container">
				...
				<div class="col-md-12 col-md-3">
					...
					<form:form class="form-sign-in" method="POST" modelAttribute="user"
						action="signup">
						...
						<div class="form-group">
							...
							<form:input path="age" type="hidden" class="form-control"
								placeholder="Age" required="true"></form:input>
						</div>
						...
						<button class="section-scroll btn btn-border-w btn-round" type="submit">Register</button>
					</form:form>
					<!-- END Sign In Form -->
